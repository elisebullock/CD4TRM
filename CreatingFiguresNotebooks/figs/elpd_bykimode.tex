...
\path (n31) edge[line width = \minw+\ewf*1.0] (n32); 
    ...
    \renewcommand{\wNh}{0.01}
    \renewcommand{\wCMh}{0.42}
    \renewcommand{\wEMh}{0.44}

    \renewcommand{\wNm}{0.46}
    \renewcommand{\wCMm}{0.42}
    \renewcommand{\wEMm}{0.26}

    \renewcommand{\wNl}{0.53}
    \renewcommand{\wCMl}{0.16}
...
\node[box, fit=(N)(CM)(EM)(trgt-EM), label=above:{Skin EM}] {};
    ...
    \renewcommand{\wRMh}{0.85}
    \renewcommand{\wNh}{0.02}
    \renewcommand{\wCMh}{0.59}
    \renewcommand{\wEMh}{0.50}

    \renewcommand{\wRMm}{0.10}
    \renewcommand{\wNm}{0.48}
    \renewcommand{\wCMm}{0.18}
    \renewcommand{\wEMm}{0.32}

    \renewcommand{\wRMl}{0.04}
    \renewcommand{\wNl}{0.50}
    \renewcommand{\wCMl}{0.24}
    \renewcommand{\wEMl}{0.19}
...
\node[box, fit=(trgt-RM)(CD69neg)(N)(CM)(CM)(EM), label=above:{Skin RM}] {};
    ...
    \renewcommand{\wNh}{0.08}
    \renewcommand{\wCMh}{0.04}
    \renewcommand{\wEMh}{0.04}

    \renewcommand{\wNm}{0.54}
    \renewcommand{\wCMm}{0.34}
    \renewcommand{\wEMm}{0.36}

    \renewcommand{\wNl}{0.38}
    \renewcommand{\wCMl}{0.61}
    \renewcommand{\wEMl}{0.59}
...
\node[box, fit=(N)(CM)(EM)(trgt-EM), label=above:{LP EM}] {};
    ...
    \renewcommand{\wRMh}{0.04}
    \renewcommand{\wNh}{0.43}
    \renewcommand{\wCMh}{0.08}
    \renewcommand{\wEMh}{0.07}

    \renewcommand{\wRMm}{0.49}
    \renewcommand{\wNm}{0.38}
    \renewcommand{\wCMm}{0.52}
    \renewcommand{\wEMm}{0.55}

    \renewcommand{\wRMl}{0.47}
    \renewcommand{\wNl}{0.19}
    \renewcommand{\wCMl}{0.39}
    \renewcommand{\wEMl}{0.38}
