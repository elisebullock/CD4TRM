...
\path (n31) edge[line width = \minw+\ewf*1.0] (n32); 
    ...
    \renewcommand{\wCMh}{0.01}
    \renewcommand{\wEMh}{0.99}

    \renewcommand{\wNm}{0.00}
    \renewcommand{\wCMm}{0.01}
    \renewcommand{\wEMm}{0.99}

    \renewcommand{\wNl}{0.00}
    \renewcommand{\wCMl}{0.00}
    \renewcommand{\wEMl}{1.00}
...
\node[box, fit=(N)(CM)(EM)(trgt-EM), label=above:{Skin EM}] {};
    ...
    \renewcommand{\wRMh}{0.83}
    \renewcommand{\wNh}{0.00}
    \renewcommand{\wCMh}{0.03}
    \renewcommand{\wEMh}{0.15}

    \renewcommand{\wRMm}{0.64}
    \renewcommand{\wNm}{0.00}
    \renewcommand{\wCMm}{0.03}
    \renewcommand{\wEMm}{0.34}

    \renewcommand{\wRMl}{0.56}
    \renewcommand{\wNl}{0.00}
    \renewcommand{\wCMl}{0.06}
...
\node[box, fit=(N)(CM)(EM)(trgt-EM), label=above:{LP EM}] {};
    ...
    \renewcommand{\wRMh}{0.16}
    \renewcommand{\wNh}{0.00}
    \renewcommand{\wCMh}{0.01}
    \renewcommand{\wEMh}{0.83}

    \renewcommand{\wRMm}{0.15}
    \renewcommand{\wNm}{0.00}
    \renewcommand{\wCMm}{0.00}
    \renewcommand{\wEMm}{0.84}

    \renewcommand{\wRMl}{0.18}
    \renewcommand{\wNl}{0.00}
    \renewcommand{\wCMl}{0.00}
    \renewcommand{\wEMl}{0.82}
